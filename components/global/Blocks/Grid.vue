...
<template>
  <section class="p-site md:p-8">
    ...
    <div class="grid grid-cols-[repeat(auto-fill,minmax(500px,1fr))] gap-site md:gap-8">
      <article
      ...
      >
        <a
          ...
          target="_blank"
          class="concert-info absolute flex flex-col bg-black/25 inset-0 p-6 text-white transition"
        >
